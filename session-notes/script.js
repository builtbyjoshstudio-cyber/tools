...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Another tab (e.g. the NPC generator's "Add to Session Notes") may write our key while
  // this page is open — re-load instead of clobbering it with stale in-memory state on next save.
